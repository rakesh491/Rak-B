...
void vbe_main_c (unsigned int address,unsigned int value){

	switch (value) {
		case 0x0:vbe_info_c(address); break;
		case 0x1:vbe_mode_info_c(address); break;
		case 0x2:vbe_start_mode_c(); break;
	}
}
